    ...
    <header className="finboard-header sticky top-0 z-50">
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
          <Button variant="outline" size="sm" asChild className="finboard-focus bg-transparent hidden sm:flex">
          ...
          {/* Mobile docs button */}
          <Button variant="ghost" size="sm" asChild className="finboard-focus sm:hidden">
            <a href="/docs" aria-label="View documentation">
              <BookText className="size-4" />
            </a>
          </Button>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="flex sm:hidden items-center gap-1">
              <Button variant="ghost" size="sm" onClick={onExport} className="finboard-focus text-xs px-2">
                Exp
              </Button>
              <Button
                variant="ghost"
            ...
            <Button onClick={onAddWidget} className="finboard-focus text-xs sm:text-sm px-2 sm:px-4">
